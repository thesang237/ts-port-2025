      ...
      <section className='relative mx-auto flex min-h-dvh w-full max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8'>
        <header className='flex flex-col gap-4 rounded-lg border border-white/15 bg-white/10 p-4 shadow-2xl shadow-black/25 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between'>
          <div>
            ...
            <h1 className='mt-1 font-extended text-3xl leading-none font-black tracking-normal text-white sm:text-4xl'>
              Weather Memory Board
            </h1>
          </div>
        ...
        <div className='grid flex-1 gap-4 lg:grid-cols-[minmax(0,1fr)_296px]'>
          <section className='min-h-[420px] rounded-lg border border-white/15 bg-[#f6e6b5]/10 p-3 shadow-2xl shadow-black/25 backdrop-blur-md sm:p-4'>
            ...
            <div className='max-h-[calc(100dvh-208px)] overflow-auto rounded-md border border-white/10 bg-black/20 p-3 sm:p-4'>
              <div
                className='mx-auto grid gap-2 sm:gap-3'
                style={{
                  gridTemplateColumns: `repeat(${columns}, minmax(42px, 1fr))`,
              ...
              >
                {cards.map((card, index) => {
                  ...
                  return (
                    <button
                      aria-label={`Board card ${index + 1}`}
                      className={`group relative aspect-[708/816] overflow-hidden rounded-md border-2 bg-[#191c40] shadow-lg shadow-black/30 transition duration-200 hover:-translate-y-1 hover:shadow-[#36d6c6]/20 ${
                        isSelected
          ...
          <aside className='rounded-lg border border-white/15 bg-white/10 p-3 shadow-2xl shadow-black/25 backdrop-blur-xl sm:p-4'>
            <div className='mb-3 flex items-center justify-between gap-3'>
              <h2 className='text-base font-black text-white'>Front Cards</h2>
